...
* HibernateException in LibraryControllerSpec integration test
...
org.hibernate.HibernateException: No Session found for current thread
    ...
    at com.example.LibraryControllerSpec.$tt__setupData(LibraryControllerSpec.groovy:22)
    at com.example.LibraryControllerSpec.setupData_closure1(LibraryControllerSpec.groovy)
    ...
    at com.example.LibraryControllerSpec.$tt__$spock_feature_0_0(LibraryControllerSpec.groovy:33)
    at com.example.LibraryControllerSpec.test save_closure2(LibraryControllerSpec.groovy)
    at groovy.lang.Closure.call(Closure.java:426)
    at groovy.lang.Closure.call(Closure.java:442)
    at grails.transaction.GrailsTransactionTemplate$1.doInTransaction(GrailsTransactionTemplate.groovy:67)
    at org.springframework.transaction.support.TransactionTemplate.execute(TransactionTemplate.java:133)
    at grails.transaction.GrailsTransactionTemplate.executeAndRollback(GrailsTransactionTemplate.groovy:64)
    at com.example.LibraryControllerSpec.test save(LibraryControllerSpec.groovy)
```
